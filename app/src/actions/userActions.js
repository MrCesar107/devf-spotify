...
// creamos una funcion para Date que nos regrese un nuevo Date con N numero de
// dias agregados.
...
// creamos una funcion que recive la data del usuario y genera un token nuevo
...
// paso 3 - regresa un token firmado por nuesto servidor con base en una clave
// secreta.
...
// loginAction - funcion que loguea al usuario, si sus credenciales son
// correctas te envia un login de autenticacion.
// Paso 1 - creamos una promesa.
// Paso 2 - buscamos en la base de datos un usario con un email en especifico
// Paso 3 - si existe el usuario comparamos el password ingresado con el
// password en la base de datos(encriptada)
      ...
      bcrypt.compare(password, user.password, (err, isValid) => {
        ...
        isValid 
          ? resolve({ token: createToken(user),
                      message: `se ha loggeado correctamente` })
...
// exportamos las acciones del usuario
